...
$Dll = Join-Path $Build 'Release/WhitePhialMenu.dll'
...
$Info = [ordered]@{
    plugin = 'WhitePhialMenu'; version = '1.2.0'; runtime = '1.6.1170'
...
Compress-Archive -Path (Join-Path $Stage '*') -DestinationPath (Join-Path $WorkDirectory 'White_Phial_Menu_SKSE_v5.zip')
