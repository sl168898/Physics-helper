...
$Sources = [ordered]@{}
foreach ($Name in @('src/main.cpp','src/Rules.h','src/LabVisit.h','tests/rules_tests.cpp','tests/lab_tests.cpp','CMakeLists.txt','vcpkg.json')) {
...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.2.0'; runtime = '1.6.1170'
    ...
    combined_version = "2.5.0"; no_new_inventory_items = $true
}
