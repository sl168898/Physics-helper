...
$Sources = [ordered]@{}
foreach ($Name in @('src/main.cpp','src/Rules.h','src/LabVisit.h','src/Skald.h','src/SkaldRuntime.h','src/EchoDiagnostics.h','tests/rules_tests.cpp','tests/lab_tests.cpp','tests/skald_tests.cpp','CMakeLists.txt','vcpkg.json','BiggieTraitMechanics.ini')) {
...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.3.2'; runtime = '1.6.1170'
    ...
    combined_version = "2.6.2"; no_new_inventory_items = $true
}
