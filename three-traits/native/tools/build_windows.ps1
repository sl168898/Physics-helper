...
$Sources = [ordered]@{}
foreach ($Name in @('src/main.cpp','src/Rules.h','tests/rules_tests.cpp','CMakeLists.txt','vcpkg.json')) {
...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.0.0'; runtime = '1.6.1170'
    ...
    combined_version = "2.4"; no_new_inventory_items = $true
}
