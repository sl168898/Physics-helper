...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.6.1'; runtime = '1.6.1170'
    ...
    source_sha256_lf = $Sources; windows_build = 'passed'; rules_tests = 'passed'; native_test_suites = 10; dynamo_charge_tests = 'passed'; scoped_charge_cost = $true; original_cost_for_magicka_payment = $true; direct_and_virtual_cast_paths = $true; fixed_resource_call_offsets_removed = $true; in_game_tested = $false
    combined_version = "2.10.10-beta1"; no_new_inventory_items = $true
}
