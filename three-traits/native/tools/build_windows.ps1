...
$Sources = [ordered]@{}
foreach ($Name in @('src/main.cpp','src/Rules.h','src/LabVisit.h','src/Skald.h','src/SkaldRuntime.h','src/SkaldDiagnostics.h','src/SkaldDeferred.h','src/EchoDiagnostics.h','src/IronLungs.h','src/IronLungsRuntime.h','src/IronLungsGrant.h','src/IronLungsImpact.h','src/Overexertion.h','tests/rules_tests.cpp','tests/lab_tests.cpp','tests/skald_tests.cpp','tests/iron_lungs_tests.cpp','tests/overexertion_tests.cpp','tests/skald_deferred_tests.cpp','tests/iron_lungs_impact_tests.cpp','CMakeLists.txt','vcpkg.json','BiggieTraitMechanics.ini')) {
...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.4.5'; runtime = '1.6.1170'
    ...
    combined_version = "2.7.5-beta1"; no_new_inventory_items = $true
}
