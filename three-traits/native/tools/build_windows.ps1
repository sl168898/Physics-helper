...
$Info = [ordered]@{
    plugin = 'BiggieTraitMechanics'; version = '1.5.0'; runtime = '1.6.1170'
    ...
    combined_version = "2.9.0-beta1"; no_new_inventory_items = $true
}
