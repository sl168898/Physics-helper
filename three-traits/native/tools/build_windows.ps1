...
$Sources = [ordered]@{}
foreach ($Name in @('src/main.cpp','src/Rules.h','src/LabVisit.h','src/Skald.h','src/SkaldRuntime.h','tests/rules_tests.cpp','tests/lab_tests.cpp','tests/skald_tests.cpp','CMakeLists.txt','vcpkg.json')) {
