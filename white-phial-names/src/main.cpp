...
extern "C" __declspec(dllexport) constinit SKSE::PluginVersionData SKSEPlugin_Version = [] {
    ...
    d.PluginVersion({2,0,1,0}); d.PluginName("WhitePhialNames"); d.AuthorName("Physics-helper contributors");
...
extern "C" __declspec(dllexport) bool SKSEPlugin_Load(const SKSE::LoadInterface* skse) {
    ...
    *path /= "WhitePhialNames.log";
    ...
    SKSE::Init(skse);
    SKSE::log::info("WhitePhialNames 2.0.1; Decanting 2.0.1 diagnostics; Skyrim 1.6.1170");
