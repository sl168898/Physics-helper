...
Event OnUpdate()
    ...
    Spell penalty = Game.GetFormFromFile(0x930, "Biggie Traits - Combined.esp") as Spell
...
Function MigrateVenomHarvester(Actor player)
    GlobalVariable version = Game.GetFormFromFile(0xA05, "Biggie Traits - Combined.esp") as GlobalVariable
    If !version || version.GetValue() >= 2.0
        Return
    EndIf
    Spell ability = Game.GetFormFromFile(0xA00, "Biggie Traits - Combined.esp") as Spell
    Perk oldPerk = Game.GetFormFromFile(0xA02, "Biggie Traits - Combined.esp") as Perk
    GlobalVariable gifts = Game.GetFormFromFile(0xA04, "Biggie Traits - Combined.esp") as GlobalVariable
